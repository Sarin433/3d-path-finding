...
def run_solver(solver_class, cetsp: CETSP, name: str, category: str,
...
def run_all_benchmarks(cetsp: CETSP, n_customers: int) -> List[BenchmarkResult]:
    ...
    results.append(run_solver(
        ...
        population_size=pop_size, generations=iterations
    ))
    ...
    results.append(run_solver(
        ...
        n_ants=pop_size, n_iterations=iterations
    ))
    ...
    results.append(run_solver(
        ...
        n_hummingbirds=pop_size, n_iterations=iterations
    ))
    ...
    results.append(run_solver(
        ...
        n_particles=pop_size, n_iterations=iterations
    ))
    ...
    results.append(run_solver(
        ...
        n_wolves=pop_size, n_iterations=iterations
    ))
...
def save_html_table(results: List[BenchmarkResult], filepath: str, 
                    n_customers: int, seed: int):
