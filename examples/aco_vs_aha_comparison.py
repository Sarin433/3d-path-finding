...
def test_scalability():
    ...
    print(
        f"{'Size':<8}{'ACO Dist':<12}{'ACO Time':<12}{'AHA Dist':<12}{'AHA Time':<12}{'Winner':<10}"
    )
    print("-" * 66)
    ...
    for n in problem_sizes:
        ...
        print(
            f"{n:<8}{aco_sol.total_distance:<12.2f}{aco_time:<12.1f}{aha_sol.total_distance:<12.2f}{aha_time:<12.1f}{winner:<10}"
        )
...
def test_convergence_speed():
    ...
    for n_iter in iterations:
        ...
        print(
            f"{n_iter:<12}{aco_sol.total_distance:<12.2f}{aco_imp:>+8.1f}%  {aha_sol.total_distance:<12.2f}{aha_imp:>+8.1f}%"
        )
...
def test_consistency():
    ...
    print(
        f"{'Best':<20}{aco_min:<15.2f}{aha_min:<15.2f}{'ACO' if aco_min < aha_min else 'AHA':<10}"
    )
    print(
        f"{'Worst':<20}{aco_max:<15.2f}{aha_max:<15.2f}{'ACO' if aco_max < aha_max else 'AHA':<10}"
    )
    print(
        f"{'Mean':<20}{aco_mean:<15.2f}{aha_mean:<15.2f}{'ACO' if aco_mean < aha_mean else 'AHA':<10}"
    )
    print(
        f"{'Std Dev':<20}{aco_std:<15.2f}{aha_std:<15.2f}{'ACO' if aco_std < aha_std else 'AHA':<10}"
    )
    print(
        f"{'Range':<20}{aco_max - aco_min:<15.2f}{aha_max - aha_min:<15.2f}{'ACO' if (aco_max - aco_min) < (aha_max - aha_min) else 'AHA':<10}"
    )
...
def test_parameter_sensitivity():
    ...
    for pop in pop_sizes:
        ...
        print(
            f"{pop:<12}{aco_sol.total_distance:<12.2f}{aco_time:<12.1f}{aha_sol.total_distance:<12.2f}{aha_time:<12.1f}"
        )
...
def test_algorithm_variants():
    ...
    algorithms = [
        ...
        (
            "Ant Colony System",
            AntColonySystemCETSP,
            {"n_ants": 30, "n_iterations": 100, "seed": 42},
        ),
        (
            "Standard AHA",
            ArtificialHummingbirdCETSP,
            {"n_hummingbirds": 30, "n_iterations": 100, "seed": 42},
        ),
