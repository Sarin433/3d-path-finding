...
class AdaptiveSimulatedAnnealingCETSP(CETSPSolver):
    ...
    def _update_operator_weights(self) -> None:
        ...
        for i in range(len(self.operators)):
            if self.operator_calls[i] > 0:
                ...
                self.operator_weights[i] = 0.9 * self.operator_weights[i] + 0.1 * (success_rate + 0.1)
    ...
    def _adapt_temperature(
        ...
        target = self.target_acceptance_high * (1 - progress) + self.target_acceptance_low * progress
    ...
    def solve(self) -> CETSPSolution:
        ...
        while temperature > self.final_temp and iteration < max_iterations:
            ...
            progress = math.log(initial_temp / temperature) / math.log(initial_temp / self.final_temp)
